        ...
        .on("mouseover", function (e, d) {
            ...
            tooltip
                ...
                .html(`
                    ...
                    <strong>Avg Dog Height:</strong> ${d.avgHeight.toFixed(1)} cm<br>
                    <strong>Avg Apartment Space:</strong> ${d.livingSpace} m²<br>
                    <strong>Total Dogs:</strong> ${d.totalDogs}<br>
                    <hr style="margin: 4px 0; border-color: rgba(255,255,255,0.4);">
                    <strong>Top 5 Breeds & Avg Height:</strong><br>
                    ${breeds}
                `);
        })
...
//load all 3 data
Promise.all([loadApartmentData(), loadDogSizeData(), loadDogData()])
    .then(([apartmentData, dogSizeDataLoaded, dogDataLoaded]) => {
